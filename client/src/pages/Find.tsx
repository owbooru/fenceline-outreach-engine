          ...
          {results.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-[13px] text-[#888] mt-3">
                Or use the <button onClick={() => setActiveTab("csv")} className="text-[var(--brand-primary)] font-semibold hover:underline">CSV Import</button> tab to bring in contacts from Scott's Directories or Sales Navigator.
              </p>
            </div>
          ) : (
            <div className="space-y-2">
